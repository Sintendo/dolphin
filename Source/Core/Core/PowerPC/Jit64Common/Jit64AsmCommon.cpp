...
void CommonAsmRoutines::GenFrsqrte()
{
  ...
  POP(RSCRATCH2);
  OR(64, R(RSCRATCH), R(RSCRATCH2));  // vali |= (s64)(frsqrte_expected_base[index] -
...
void CommonAsmRoutines::GenFres()
{
  ...
  SUB(32, R(RSCRATCH), Imm8(1));
  SAR(32, R(RSCRATCH), Imm8(1));
  ...
  OR(64, R(RSCRATCH), R(RSCRATCH_EXTRA));  // vali |= (s64)(fres_expected_base[i / 1024] -
